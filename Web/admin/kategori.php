                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
                                            ...
                                            <?php $i = 1; foreach($listKategori as $kategori): 
                                                    $jumlahBarang = mysqli_query($conn, "SELECT COUNT(id_Barang) AS jumlahBarang FROM barang WHERE jenis = '".$kategori['nama']."'");
                                                    $jumlahBarang = mysqli_fetch_assoc($jumlahBarang);
                                                    $jumlahBarang = $jumlahBarang['jumlahBarang'];
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form method="post" action="assets/PHP/add-category.php">
