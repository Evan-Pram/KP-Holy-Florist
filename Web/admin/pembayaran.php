<?php
    require 'assets/PHP/load-pembayaran.php';
?>
                            ...
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
                                        ...
                                        <tbody>
                                        <?php $i=1;foreach($listPembayaran as $metode): ?>
                                            <tr>
                                                <td><?= $i ?></td>
                                                <td><?= $metode['metode'] ?></td>
                                                <td><?= $metode['noRek'] ?></td>
                                                <td><?= $metode['an'] ?></td>
                                                <td><?= $metode['logo'] ?></td>
                                                <?php if($metode['status'] == 1): ?>
                                                <td>
                                                    <a href="assets/PHP/rubah-status-pembayaran.php?id=<?=$metode['id']?>" onclick="return confirm('Anda yakin untuk menonaktifkan metode pembayaran?')">
                                                        <button class="btn btn-primary">Aktif</button>
                                                    </a>
                                                </td>
                                                <?php else: ?>
                                                <td>
                                                    <a href="assets/PHP/rubah-status-pembayaran.php?id=<?=$metode['id']?>">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form method="post" action="assets/PHP/add-pembayaran.php">
