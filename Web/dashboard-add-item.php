<?php
    require 'PHP/add-item-process.php';
    require 'PHP/dashboard-session.php';

    // button add barang diklik
    if (isset($_POST['addBarang'])) {
        $insert = tambahBarang($_POST);
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="../Web/dashboard-list-item.php" class="nav-link">
                        ...
                        <li class="nav-item menu-open">
                            <a href="../Web/dashboard-add-item.php" class="nav-link active">
                                ...
                                <form action="" method="post" enctype="multipart/form-data" id="formBarang">
                                    <div class="card-body row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukan Data" name="name">
                                        </div>
                                        ...
                                        <div class="form-group col-md-3">
                                            <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <input type="text" class="form-control numberOnly" id="panjangBarang" placeholder="Panjang" name="panjang">
                                                    </div>
                                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control numberOnly" id="exampleInputEmail1" placeholder="Masukan Data" name="harga">
                                        </div>
                                        <div class="form-group col-md-3">
                                    ...
                                    <div class="card-footer">
                                        <button type="submit" class="btn btn-primary" id="btnAdd" name="addBarang">Masukan</button>
                                    </div>
                                </form>
                            </div>
                            <!-- /.card -->
    ...
    <!-- Javascript for Form -->
    <script src="Asset/js/form-add-item.js"></script>
