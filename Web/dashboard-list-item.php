...
<head>
    ...
    <title>List Item | Dashboard</title>
                            ...
                            <div class="card card-primary">
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body row">
                                        <div class="col-md-1 col-1">
                                            <h3 class="card-title"><?php echo $i+1 ?></h3>
                                        </div>
                                        <div class="col-md-7 col-7">
                                            <h3 class="card-title">
                                                <a
                                                    href="dashboard-item-detail.php?id=<?= $listBarang[$i]['id_Barang'] ?>">
                                        ...
                                        <div class="col-md-2 col-2">
                                            <h3 class="card-title">
                                                <button type="button" class="btn btn-success mb-2"
                                                    onclick="window.location.href='dashboard-item-detail.php?id=<?= $listBarang[$i]['id_Barang'] ?>'">
                                        ...
                                        <div class="col-md-2 col-2">
                                                <?php if($listBarang[$i]["status"] == 0): ?>
                                                    <a href="PHP/rubah-status.php?id=<?= $listBarang[$i]["id_Barang"] ?>" >
                                                        <button type="button" class="btn btn-warning" name="btn-rubah-status">non-aktif</button>
                                                    </a>
                                                <?php elseif($listBarang[$i]["status"] == 1): ?>
                                                    <a href="PHP/rubah-status.php?id=<?= $listBarang[$i]["id_Barang"] ?>"  onclick="return confirm('Apakah Anda Yakin Menonaktifkan Item?')">
